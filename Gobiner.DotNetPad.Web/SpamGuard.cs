...
namespace Gobiner.DotNetPad.Web
{
    public static class SpamGuard
    {
        ...
        static string[] CSharpKeywords = { "abstract", "base", "bool", "break", "byte", "case", "catch", "char", "checked", "class", "const", "continue", "decimal", "default", "delegate", "double", "enum", "event", "explicit", "extern", "false", "finally", "fixed", "float", "foreach", "goto", "implicit", "int", "interface", "internal", "lock", "long", "namespace", "new", "null", "object", "operator", "out", "out (generic modifier)", "override", "params", "private", "protected", "public", "readonly", "ref", "return", "sbyte", "sealed", "short", "sizeof", "stackalloc", "static", "string", "struct", "switch", "this", "throw", "true","typeof", "uint", "ulong", "unchecked", "unsafe", "ushort", "using", "virtual", "void", "volatile", "while" };
        ...
        public static int ContentScore(Language language, string content)
        {
			if (!LanguageKeywords.ContainsKey(language)) return 0;
            int keyword_count = Regex.Replace(content, "[^a-z]", " ", RegexOptions.IgnoreCase).Split(' ')
                .Select(w => w.ToLower())
